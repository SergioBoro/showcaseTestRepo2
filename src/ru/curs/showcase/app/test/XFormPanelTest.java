...
public class XFormPanelTest extends GWTTestCase {
	...
	// CHECKSTYLE:OFF
	static final String XFORM_BODY =
	...
	static final String XFORM_SCRIPT1 =
	...
	static final String XFORM_SCRIPT2 =
	...
	public void testConstr2() {
		...
		assertTrue(((HTML) xfp.getPanel().getWidget(0)).getHTML().indexOf("Любимая музыка (2):") > 0);
		...
		assertTrue(xfp.getMainInstance().indexOf("</music><comment") > 0);
