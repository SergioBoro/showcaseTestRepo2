 ...
 * 
 */
public class GridJythonDownloadHelper extends JythonQuery<JythonDownloadResultForGrid> {
	...
	protected GridJythonDownloadHelper(final CompositeContext aContext,
		...
		super(JythonDownloadResultForGrid.class);
	...
	protected Object execute() {
		...
		setParameters(attr);
		return getProc().getInputStreamForGrid(context, attr);
	}
