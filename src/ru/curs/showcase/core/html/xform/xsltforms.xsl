...
<!-- КУРС Forms Server: Изменена кодировка xsl на UTF-8, output-кодировка на UTF-8, 
вставлено содержимое файла config.xsl, заменена ссылка на config.

закоменчено: xmlns:msxsl="urn:schemas-microsoft-com:xslt" 
...
version="1.0" 
exclude-result-prefixes="xhtml xforms ev exslt"> <!-- msxsl -->
<xsl:output method="xml" 
encoding="utf-8" 
omit-xml-declaration="no" 
indent="no" />
<!--  Всё равно дальнейшие трансформации это не понимают.
...
-->
		...
		<xsl:variable xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="config" select="$confignodes"/><!--Убрана функция пространства имен exslt чтобы работало под Saxon-->
				...
				<head>
					...
					<script type="text/javascript">
						...
						<xsl:call-template name="xps">
							<xsl:with-param name="ps" select="$xexprs/xexprs"/><!--Убрана функция пространства имен exslt чтобы работало под Saxon-->
						</xsl:call-template>
