function createPageDGrid(elementId, parentId, metadata) {
	require([
			 ...
			 "dojo/domReady!"
        		 ...
        		 lang, has, List, Grid, Pagination, CompoundColumns, ColumnSet, ColumnResizer, Selection, CellSelection, Editor, Keyboard, declare, QueryResults, Rest, Trackable, Cache, when
		     ){
