define("ColumnResizer", [
         ...
         "put-selector/put", 
         "dojo/_base/html", 
         "xstyle/css!dgrid/css/extensions/ColumnResizer.css"
       ],
...
return declare(null, {
	...
	_resizeMouseUp: function(e){
		...
		var	lastCol = obj.lastColId;
		
		
//		var	lastColWidth = query(".dgrid-column-"+lastCol, this.headerNode)[0].offsetWidth;
		var	lastColWidth = 5000;
		if(lastCol){
